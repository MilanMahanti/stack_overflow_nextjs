...
const RightSidebar = () => {
  return (
    <section className="background-light900_dark200 custom-scrollbar light-border  sticky right-0 top-0 z-30 flex min-h-screen w-[350px] flex-col items-start overflow-y-auto p-6 pt-32  shadow-light-300 dark:shadow-none max-sm:hidden">
      <div className="mb-16 ">
